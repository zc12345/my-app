...
1. 登录注册的正则表达式验证搞定了
2. 生日格式的问题解决了
3. 登录注册表单返回信息Fielderror还没有处理
4. 注册填表的时候warning问题解决了
5. 注册页面新增了description属性，存储个人简介
6. 新增了很多组件或者组件声明
7. 拿到了一部分后端接口，接下来要做提交的作业的列表
8. 面试列表提交后刷新的问题还没有解决

# 03/12/2017
## 关于今天解决的问题
1. 生日的时间限制问题解决了
2. 表单返回fielderror的基本显示能够出来了，虽然效果还不是很理想
3. 前后端数据交互还勉强能做出来，组件之间的数据传递还是很头疼，我觉着不把这方面的练习熟练应该没法很清楚的理解redux
4. 登录和注销这一个是真的绕不过去了，好像真的要做一个redux
