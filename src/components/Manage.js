        ...
        <Sider width={200} style={{ background: '#fff' }}>
          ...
          >
            <SubMenu key="filework" title={<span><Icon type="user" />文件作业</span>}>
              ...
              <Menu.Item key="upload">上传文件</Menu.Item>
              <Menu.Item key="filelist">文件列表</Menu.Item>
            </SubMenu>
            <SubMenu key="members" title={<span><Icon type="laptop" />新生部员</span>}>
              <Menu.Item key="memberList">部员管理</Menu.Item>
            ...
            <SubMenu key="meetingNotice" title={<span><Icon type="notification" />例会通知</span>}>
              ...
              <Menu.Item key="signin">例会签到</Menu.Item>
            </SubMenu>
          </Menu>
        </Sider>
